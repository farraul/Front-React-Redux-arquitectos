...
function Pie_chart_architects() {
  ...
  var data = [
    { label: 'Hombres:', value: 26 },
    { label: 'Mujeres', value: 44 },
   
  ];
  var colors = ['#007025',  '#51af70'];
  ...
  return (
    ...
    <div className=''>
      <canvas id="pie_archi" width="385"  height="400">eee</canvas>
    </div>
  );
}

export default Pie_chart_architects;