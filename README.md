...
#### Perfil (Arquitecto)
En perfil podremos:
* Ver la información del arquitecto
* Actualizar la información del arquitecto
...
Para actualizar los datos de nuestro perfil, clicaremos en en "Actualizar" y nos saldrá el siguiente pop-up:
